...
function addBlog(event) {
  ...
  const robot = '<img class="img-icon" src="Image/robot.png">';
  const animal = '<img class="img-icon" src="Image/animal.png">';
  const demon = '<img class="img-icon" src="Image/demon.png">';
  const human = '<img class="img-icon" src="Image/human.png">';
